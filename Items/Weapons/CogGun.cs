...
namespace steampunk.Items.Weapons
{
	public class CogGun : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("A worse version of the clockwork assualt rifle");
		}
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(mod, "BrassCog", 3);
